...
import com.uhasoft.guardian.util.function.Supplier;
...
public class SentinelReactorSubscriber<T> extends InheritableBaseSubscriber<T> {
    ...
    public Context currentContext() {
        ...
        com.uhasoft.guardian.context.Context sentinelContext = currentEntry.getAsyncContext();
    ...
    private void doWithContextOrCurrent(Supplier<Optional<com.uhasoft.guardian.context.Context>> contextSupplier,
                                        Runnable f) {
        Optional<com.uhasoft.guardian.context.Context> contextOpt = contextSupplier.get();
