 ...
 */
package com.uhasoft.guardian.adapter.jaxrs.config;

import com.uhasoft.guardian.adapter.jaxrs.fallback.DefaultSentinelJaxRsFallback;
import com.uhasoft.guardian.adapter.jaxrs.fallback.SentinelJaxRsFallback;
import com.uhasoft.guardian.adapter.jaxrs.request.DefaultRequestOriginParser;
import com.uhasoft.guardian.adapter.jaxrs.request.DefaultResourceNameParser;
import com.uhasoft.guardian.adapter.jaxrs.request.RequestOriginParser;
import com.uhasoft.guardian.adapter.jaxrs.request.ResourceNameParser;
