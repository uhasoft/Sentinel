...
import com.uhasoft.guardian.BaseTest;
import com.uhasoft.guardian.DubboTestUtil;
...
import com.uhasoft.guardian.slots.block.degrade.DegradeRuleManager;
...
import static com.uhasoft.guardian.slots.block.RuleConstant.DEGRADE_GRADE_EXCEPTION_RATIO;
...
public class SentinelDubboConsumerFilterTest extends BaseTest {
    ...
    private void verifyInvocationStructure(Invoker invoker, Invocation invocation) {
        ...
        assertEquals(com.uhasoft.guardian.Constants.CONTEXT_DEFAULT_NAME, context.getName());
        assertEquals("", context.getOrigin());

        DefaultNode entranceNode = context.getEntranceNode();
        ResourceWrapper entranceResource = entranceNode.getId();

        assertEquals(com.uhasoft.guardian.Constants.CONTEXT_DEFAULT_NAME, entranceResource.getName());
