...
import com.uhasoft.guardian.adapter.dubbo.config.DubboAdapterGlobalConfig;
import com.uhasoft.guardian.adapter.dubbo.provider.DemoService;
...
public class DubboUtilsTest {
    ...
    public void testGetResourceName() throws NoSuchMethodException {
        ...
        assertEquals("com.uhasoft.guardian.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
    ...
    public void testGetResourceNameWithGroupAndVersion() throws NoSuchMethodException {
        ...
        assertEquals("com.uhasoft.guardian.adapter.dubbo.provider.DemoService:1.0.0:grp1:sayHello(java.lang.String,int)", resourceNameUseGroupAndVersion);
    }
    ...
    public void testGetResourceNameWithPrefix() throws NoSuchMethodException {
        ...
        assertEquals("dubbo:provider:com.uhasoft.guardian.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        ...
        assertEquals("dubbo:consumer:com.uhasoft.guardian.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        ...
        assertEquals("my:dubbo:provider:com.uhasoft.guardian.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
        resourceName = DubboUtils.getMethodResourceName(invoker, invocation, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("my:dubbo:consumer:com.uhasoft.guardian.adapter.dubbo.provider.DemoService:sayHello(java.lang.String,int)", resourceName);
    ...
    public void testGetInterfaceName() {
        ...
        SentinelConfig.setConfig(DubboAdapterGlobalConfig.DUBBO_INTERFACE_GROUP_VERSION_ENABLED, "false");
        assertEquals("com.uhasoft.guardian.adapter.dubbo.provider.DemoService", DubboUtils.getInterfaceName(invoker));
    ...
    public void testGetInterfaceNameWithGroupAndVersion() throws NoSuchMethodException {
        ...
        assertEquals("com.uhasoft.guardian.adapter.dubbo.provider.DemoService:1.0.0:grp1", DubboUtils.getInterfaceName(invoker, true));
    }
    ...
    public void testGetInterfaceNameWithPrefix() throws NoSuchMethodException {
        ...
        assertEquals("dubbo:provider:com.uhasoft.guardian.adapter.dubbo.provider.DemoService", resourceName);
        resourceName = DubboUtils.getInterfaceName(invoker, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("dubbo:consumer:com.uhasoft.guardian.adapter.dubbo.provider.DemoService", resourceName);
        ...
        assertEquals("my:dubbo:provider:com.uhasoft.guardian.adapter.dubbo.provider.DemoService", resourceName);
        resourceName = DubboUtils.getInterfaceName(invoker, DubboAdapterGlobalConfig.getDubboConsumerResNamePrefixKey());
        assertEquals("my:dubbo:consumer:com.uhasoft.guardian.adapter.dubbo.provider.DemoService", resourceName);
