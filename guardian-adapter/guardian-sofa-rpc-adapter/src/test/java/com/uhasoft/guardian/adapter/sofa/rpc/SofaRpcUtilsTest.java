...
public class SofaRpcUtilsTest {
    ...
    public void testGetInterfaceResourceName() {
        SofaRequest request = new SofaRequest();
        request.setInterfaceName("com.uhasoft.guardian.adapter.sofa.rpc.service.DemoService");
        String interfaceResourceName = SofaRpcUtils.getInterfaceResourceName(request);
        assertEquals("com.uhasoft.guardian.adapter.sofa.rpc.service.DemoService", interfaceResourceName);
    }
    ...
    public void testGetMethodResourceName() {
        ...
        assertEquals("com.uhasoft.guardian.adapter.sofa.rpc.service.DemoService#sayHello(java.lang.String,int)", methodResourceName);
    }
