 ...
 */
package com.uhasoft.guardian.annotation.aspectj.integration;

import com.uhasoft.guardian.annotation.aspectj.integration.config.AopTestConfig;
import com.uhasoft.guardian.annotation.aspectj.integration.service.BarService;
import com.uhasoft.guardian.annotation.aspectj.integration.service.FooService;
import com.uhasoft.guardian.annotation.aspectj.integration.service.FooUtil;
...
import com.uhasoft.guardian.util.MethodUtil;
...
public class SentinelAnnotationIntegrationTest extends AbstractJUnit4SpringContextTests {
    ...
    public void testClassLevelDefaultFallbackWithSingleParam() {
        ...
        String resourceName1 = "com.uhasoft.guardian.annotation.aspectj.integration.service.BarService:doSomething(int)";
