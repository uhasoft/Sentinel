 ...
 */
package com.uhasoft.guardian.dashboard.controller.gateway;

import com.uhasoft.guardian.dashboard.auth.AuthorizationInterceptor;
import com.uhasoft.guardian.dashboard.auth.FakeAuthServiceImpl;
import com.uhasoft.guardian.dashboard.client.SentinelApiClient;
import com.uhasoft.guardian.dashboard.datasource.entity.gateway.GatewayFlowRuleEntity;
import com.uhasoft.guardian.dashboard.datasource.entity.gateway.GatewayParamFlowItemEntity;
import com.uhasoft.guardian.dashboard.discovery.AppManagement;
import com.uhasoft.guardian.dashboard.discovery.SimpleMachineDiscovery;
import com.uhasoft.guardian.dashboard.domain.Result;
import com.uhasoft.guardian.dashboard.domain.vo.gateway.rule.AddFlowRuleReqVo;
import com.uhasoft.guardian.dashboard.domain.vo.gateway.rule.GatewayParamFlowItemVo;
import com.uhasoft.guardian.dashboard.domain.vo.gateway.rule.UpdateFlowRuleReqVo;
import com.uhasoft.guardian.dashboard.repository.gateway.InMemGatewayFlowRuleStore;
...
public class GatewayFlowRuleControllerTest {
    ...
    public void testQueryFlowRules() throws Exception {
        ...
        entity.setGrade(RuleConstant.FLOW_GRADE_QPS);
        entity.setCount(5D);
        entity.setInterval(30L);
        entity.setIntervalUnit(GatewayFlowRuleEntity.INTERVAL_UNIT_SECOND);
        entity.setControlBehavior(RuleConstant.CONTROL_BEHAVIOR_DEFAULT);
        entity.setBurst(0);
        ...
        entity2.setControlBehavior(RuleConstant.CONTROL_BEHAVIOR_DEFAULT);
        entity2.setBurst(0);
    ...
    public void testAddFlowRule() throws Exception {
        ...
        reqVo.setGrade(RuleConstant.FLOW_GRADE_QPS);
        reqVo.setCount(5D);
        reqVo.setInterval(30L);
        reqVo.setIntervalUnit(GatewayFlowRuleEntity.INTERVAL_UNIT_SECOND);
        reqVo.setControlBehavior(RuleConstant.CONTROL_BEHAVIOR_DEFAULT);
        reqVo.setBurst(0);
    ...
    public void testUpdateFlowRule() throws Exception {
        ...
        reqVo.setControlBehavior(RuleConstant.CONTROL_BEHAVIOR_RATE_LIMITER);
        ...
        Assert.assertEquals(RuleConstant.CONTROL_BEHAVIOR_RATE_LIMITER, entity.getControlBehavior().intValue());
