...
import com.uhasoft.guardian.dashboard.auth.AuthAction;
import com.uhasoft.guardian.dashboard.auth.AuthService;
...
import com.uhasoft.guardian.dashboard.discovery.MachineInfo;
...
public class GatewayFlowRuleController {
    ...
    public Result<GatewayFlowRuleEntity> addFlowRule(@RequestBody AddFlowRuleReqVo reqVo) {
        ...
        if (!Arrays.asList(RuleConstant.CONTROL_BEHAVIOR_DEFAULT, RuleConstant.CONTROL_BEHAVIOR_RATE_LIMITER).contains(controlBehavior)) {
