package com.uhasoft.guardian.config;
...
import static com.uhasoft.guardian.util.ConfigUtil.addSeparator;
...
//    @Test
    ...
    public void testLoadProperties() throws IOException {
        ...
        try {
            ...
            out.write(buildPropertyStr(SentinelConfig.CHARSET, "utf-8"));
            out.write("\n");
            out.write(buildPropertyStr(SentinelConfig.SINGLE_METRIC_FILE_SIZE, "1000"));
            out.write("\n");
            out.write(buildPropertyStr(SentinelConfig.TOTAL_METRIC_FILE_COUNT, "20"));
            out.write("\n");
            out.write(buildPropertyStr(SentinelConfig.COLD_FACTOR, "123"));
            out.write("\n");
            out.write(buildPropertyStr(SentinelConfig.STATISTIC_MAX_RT, "6000"));
            out.write("\n");
            out.write(buildPropertyStr(SentinelConfig.PROJECT_NAME_PROP_KEY, "sentinel_test"));
            out.flush();
            out.close();

            Assert.assertTrue(SentinelConfig.getConfig(SentinelConfig.CHARSET).equals("utf-8"));
            Assert.assertTrue(SentinelConfig.getConfig(SentinelConfig.SINGLE_METRIC_FILE_SIZE).equals("1000"));
            Assert.assertTrue(SentinelConfig.getConfig(SentinelConfig.TOTAL_METRIC_FILE_COUNT).equals("20"));
            Assert.assertTrue(SentinelConfig.getConfig(SentinelConfig.COLD_FACTOR).equals("5"));
            Assert.assertTrue(SentinelConfig.getConfig(SentinelConfig.STATISTIC_MAX_RT).equals("1000"));
