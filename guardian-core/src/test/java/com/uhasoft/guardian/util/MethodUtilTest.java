...
public class MethodUtilTest {
    ...
    public void testResolveMethodName() {
        ...
        assertEquals("com.uhasoft.guardian.util.MethodUtilTest$GoodClass:foo(long[],java.lang.String,java.lang.Integer[])",
        ...
        assertEquals("com.uhasoft.guardian.util.MethodUtilTest$GoodClass:baz(double)",
