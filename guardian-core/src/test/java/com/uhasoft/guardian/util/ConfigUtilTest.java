...
import static com.uhasoft.guardian.log.LogBase.LOG_DIR;
import static com.uhasoft.guardian.log.LogBase.LOG_OUTPUT_TYPE;
...
public class ConfigUtilTest {
    ...
    public void testLoadProperties() throws IOException {
        ...
        try {
            ...
            file = new File(ConfigUtil.addSeparator(userDir) + "target/classes/" + fileName);
            if (!file.exists()) {
                file.createNewFile();
            }
